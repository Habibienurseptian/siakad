        ...
        <div class="px-6 py-4">
            <form action="{{ route('admin.murid.store') }}" method="POST" id="formTambahMurid-{{ $sekolah->id }}" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="kelas_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500" required>
                ...
                <div class="flex justify-end gap-3 px-6 py-4 border-t">
                    <button type="button"
                            onclick="document.getElementById('modalMurid-{{ $sekolah->id }}').classList.add('hidden')"
