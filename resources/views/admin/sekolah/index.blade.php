                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center gap-2 pt-4 border-t border-gray-100">
                        ...
                        <a href="{{ route('admin.sekolah.show', $sekolah->id) }}" 
                            class="flex-1 flex items-center justify-center px-3 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors duration-200 group/btn"
                            title="Detail">
                        ...
                        <a href="{{ route('admin.sekolah.edit', $sekolah->id) }}" 
                            class="flex-1 flex items-center justify-center px-3 py-2 bg-amber-50 text-amber-600 rounded-lg hover:bg-amber-100 transition-colors duration-200 group/btn"
                            title="Edit">
                            <svg class="w-4 h-4 group-hover/btn:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Delete Button -->
                        <form action="{{ route('admin.sekolah.destroy', $sekolah->id) }}" 
                            method="POST" 
                            ...
                            @method('DELETE')
                            <button type="submit" 
                                class="w-full flex items-center justify-center px-3 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors duration-200 group/btn"
                                title="Hapus">
                                <svg class="w-4 h-4 group-hover/btn:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
