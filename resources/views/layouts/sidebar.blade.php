    ...
    <header class="p-5 border-b border-gray-100">
        <a href="#" class="flex items-center space-x-3">
            <div class="w-10 h-10  rounded-xl flex items-center justify-center">
                <img src="{{ asset('images/logo.png') }}" alt="Logo Sekolah" class="w-10 h-8">
            </div>
            <span class="text-lg font-bold text-gray-900">Assalafi Al Fithrah</span>
        </a>
    </header>
            ...
            @case('staf')
                ...
                @if(Str::contains($bidang, 'keu') || $bidang === 'keuangan')
                    ...
                    <a href="{{ route('staf.tagihan.index') }}" 
                       class="nav-link {{ request()->is('staf/tagihan*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        <span>Tagihan</span>
                    </a>
                    <a href="{{ route('staf.spp.index') }}" 
                       class="nav-link {{ request()->is('staf/spp*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
