        ...
        <div class="bg-white rounded-3xl shadow-sm overflow-hidden">
            ...
            <div class="relative bg-gradient-to-br from-green-500 to-emerald-600 px-6 pt-8 pb-24">
                <div class="flex justify-end gap-3">
                    ...
                    <a href="{{ route('murid.password.reset') }}" class="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white font-medium px-4 py-2 rounded-xl transition-all duration-200">
