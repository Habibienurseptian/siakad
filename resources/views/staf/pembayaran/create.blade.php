        ...
        <div class="mb-8 bg-white rounded-2xl shadow-lg border border-green-100 overflow-hidden">
            <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <h2 class="text-xl font-bold text-white">{{ $murid->user->name ?? '-' }}</h2>
                        <p class="text-green-100 text-sm">{{ $murid->nomor_induk }} • Kelas {{ strtoupper($murid->kelas->nama_kelas ?? '-') }}</p>
                    </div>
                    <div class="text-right">
                        <div class="text-green-100 text-sm">Sekolah</div>
                        <div class="text-white font-semibold">{{ $murid->sekolah->nama ?? '-' }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative bg-white rounded-2xl shadow-lg border border-green-100 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-emerald-600 to-teal-700 px-6 py-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-white">Form Input Tagihan</h2>
                            <p class="text-emerald-100 text-sm">Masukkan detail tagihan untuk siswa</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Form Content -->
                <div class="p-8">
                    <form method="POST" action="{{ route('staf.pembayaran.input.store', $murid->id) }}">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               name="pembayaran_spp" 
                                               class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 hover:border-green-300 group-hover:shadow-sm"
                                               placeholder="0">
                                    </div>
                                </div>
