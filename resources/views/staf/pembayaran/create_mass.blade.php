    ...
    <div class="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-6">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Input Tagihan Massal</h1>
                    <p class="text-gray-600">Buat tagihan untuk seluruh siswa di <span class="font-semibold text-green-600">{{ $sekolah->nama }}</span></p>
                </div>
            </div>
        </div>
                        ...
                        <div class="mb-8 p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h4 class="text-lg font-semibold text-green-800">Total per Siswa</h4>
                                        <p class="text-sm text-green-600">Jumlah tagihan yang akan dibuat untuk setiap siswa</p>
                                    </div>
                                </div>
