<div id="modalTambahSPP" class="fixed inset-0 bg-black bg-opacity-40 hidden items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-lg mx-4">
        <!-- Header Modal -->
        <div class="flex justify-between items-center px-6 py-4 border-b">
            <h2 class="text-lg font-bold text-green-700">Tambah Komponen SPP</h2>
        ...
        <!-- Form Tambah -->
        <form action="{{ route('staf.spp.store') }}" method="POST" class="px-6 py-4 space-y-4">
            @csrf
            <div>
                <label class="block text-sm font-semibold mb-1">Nama Komponen</label>
                <input type="text" name="nama" placeholder="Contoh: U. Makan, S. Pondok" 
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="jumlah_default" placeholder="150000"
