...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::put('sekolah/{id}/kelas/{kelasId}', [SekolahController::class, 'updateKelas'])->name('sekolah.kelas.update');
        Route::delete('sekolah/{id}/kelas/{kelasId}', [SekolahController::class, 'destroyKelas'])->name('sekolah.kelas.destroy');
    ...
    Route::middleware(['role:staf'])->prefix('staf')->name('staf.')->group(function () {
        ...
        Route::middleware(['bidang:akademik'])->group(function () {
        ...
        Route::middleware(['bidang:keuangan'])->group(function () {
    ...
    Route::middleware(['role:murid'])->prefix('murid')->name('murid.')->group(function () {
        ...
        Route::post('/pembayaran/{id}/ipaymu', [\App\Http\Controllers\Murid\PembayaranController::class, 'ipaymu'])
            ->middleware(['auth', 'role:murid'])
            ->name('pembayaran.ipaymu');

        Route::post('/pembayaran/notify', [\App\Http\Controllers\Murid\PembayaranController::class, 'notify'])
            ->name('pembayaran.notify');
